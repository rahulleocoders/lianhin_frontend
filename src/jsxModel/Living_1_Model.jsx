...
const Living_1_Model = (props) => {
    const loader = new THREE.TextureLoader();
    const group = useRef()
    const { nodes, materials } = useGLTF('./blender_model/living_1.glb')
        ...
        <group ref={group} {...props} dispose={null}>
            <group position={[-34.19, 0.5, 4.42]} scale={[1, 1.92, 1.47]}>
                <mesh
                    ...
                    position={[1.51, 0.06, -4.37]}
                    scale={4.58}
                />
            </group>
            <group position={[-12.36, 0, 17.3]}>
                <group position={[-4.09, 6.8, -10.87]} scale={[1.13, 1.67, 1.13]}>
            ...
            <mesh
                ...
                position={[-26.4, 5.59, 14.18]}
                scale={[2.65, 1.19, 5.44]}
            />
            <group position={[-14.47, 6.62, 7.65]} scale={7.39}>
...
useGLTF.preload('./blender_model/living_1.glb')

export default Living_1_Model